...
const PropertyEditForm = () => {
    ...
    useEffect(() => {
        ...
        const fetchPropertyData = async () => {
            try {
                ...
                // Check rates for null values and set them to empty strings if they are null.
    ...
    const handleChange = (e) => {
        ...
        // Handle nested fields (ex: location.street, rates.weekly, etc.)
        if (name.includes(".")) {
            const [outerKey, innerKey] = name.split("."); // ex: location.street => ['location', 'street']
            // Update the state with the new value for the nested field
            setFields((prevFields) => ({
                ...prevFields, // Keep the previous state
                // Update the outer key
                [outerKey]: {
                    ...prevFields[outerKey], // Keep the previous state of the outer key
                    [innerKey]: value, // Update the inner key
                },
            }));
        } else {
    ...
    const handleAmenitiesChange = (e) => {
        ...
        //Clone the current ameities array
    ...
    return (
        mounted &&
        !loading && (
            // Since there's an images field, we add encType="multipart/form-data" to the form tag to allow file uploads.
